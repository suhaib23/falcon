...
client.on("ready", () => {
  ...
  client.user.setActivity(`FALCON GANG`, { type: "WATCHING" });
});
...
client.on("message", message => {
  if (message.content === "دخول") {
    message.channel.send("**:تم تسجيل دخولك في عصابة :eagle:FALCON:eagle::**");
    message.channel.sendFile("");
  }
});
client.on("message", message => {
  if (message.content === "خروج") {
    message.channel.send("**:تم تسجيل خروجك من عصابة :eagle:FALCON:eagle::**");
    message.channel.sendFile("");
  }
});
client.on("message", message => {
